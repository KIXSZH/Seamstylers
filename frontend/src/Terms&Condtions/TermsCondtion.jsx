  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with seamstylers! We appreciate your business
          and your interest in our fabrics. We want to make sure you
        ...
        <p>
          ...
          agreed to in writing by seamstylers.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to seamstylers's acceptance. We may refuse to
        ...
        <p>
          ...
          seamstylers. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock seamstylers products. We
        ...
        <p>
          ...
          taxes, except for those based on seamstylers's income. If
          seamstylers is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without seamstylers's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold seamstylers harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between seamstylers and
