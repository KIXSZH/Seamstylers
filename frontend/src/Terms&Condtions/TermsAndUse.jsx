    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, seamstylers.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with seamstylers
          ...
          agreed to or set forth in writing by seamstylers, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to seamstylers's acceptance. This means
          seamstylers may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, seamstylers
        ...
        <p>
          ...
          and it is accepted by seamstylers. Prices for products displayed on
          ...
          website may differ from those in stores that stock seamstylers
          products, as these stores are independent of seamstylers.
          seamstylers reserves the right to amend pricing for any pricing
          ...
          submitted an online order, seamstylers will notify you of the error
        ...
        <p>
          ...
          seamstylers reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse seamstylers if it pays, any
          taxes, except for those based on seamstylers's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by seamstylers for when the
          ...
          are beyond our control. seamstylers cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by seamstylers, customer
          may not cancel such accepted order without seamstylers’s prior
          ...
          expenses. The product(s) must be returned to seamstylers within
        ...
        <p>
          ...
          indemnify and hold seamstylers harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>seamstylers</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@seamstylers.com</span>
        </p>
      </div>
    </div>
  );
