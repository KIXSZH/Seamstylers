          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The seamstylers Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The seamstylers Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge seamstylers will use my information in accordance
              with its
